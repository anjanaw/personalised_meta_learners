...
import numpy as np
import personalised_mn.mex_1m.pm_tg as tg
import os
import math
import argparse
...
parser.add_argument("-q", "--qry_num_per_class", type=int, default=1000)
...
def main():
    ...
    for episode in range(EPISODE):
        ...
        task = tg.ACTTask(metatrain_character_folders, CLASS_NUM, SAMPLE_NUM_PER_CLASS, qry=QRY)
