...
import numpy as np
import personalised_rn.mex_1m.pm_task_generator as tg
import math
import argparse
import os
import random
...
def main():
    ...
    for episode in range(EPISODE):
        ...
        task = tg.PMTask(metatrain_character_folders, CLASS_NUM, SPT_NUM_PER_CLASS, qry=QRY)
        ...
        if (episode + 1) % 5 == 0:
            ...
            for i in range(TEST_EPISODE):
                task = tg.PMTask(metatest_character_folders, CLASS_NUM, SPT_NUM_PER_CLASS)
