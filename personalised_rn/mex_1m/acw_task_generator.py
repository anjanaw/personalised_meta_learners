...
def acw_folders(test_person):
    data_folder = '/home/mex/data/acw_maml/'
...
class ACW(FewShotDataset):

    def __init__(self, *args, **kwargs):
        super(ACW, self).__init__(*args, **kwargs)
